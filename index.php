...
<body class="bg-zinc-50 text-zinc-900 antialiased">
  ...
  <section class="py-24 px-6 text-center">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="flex gap-4 justify-center flex-wrap">
        <a href="#extension" class="inline-flex items-center px-6 py-3 bg-accent-500 hover:bg-accent-600 text-white font-medium rounded-lg transition-colors">Get Started</a>
  ...
  <section id="extension" class="py-16 px-6 bg-white border-y border-zinc-200">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            ...
            <div class="flex gap-3 flex-wrap">
              <a href="https://chromewebstore.google.com/detail/ano-%E2%80%94-qa-bug-reporting/ndncffnjpgdmpiaegjndohfdnfgfeimf" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-accent-500 hover:bg-accent-600 text-white text-sm font-medium rounded-lg transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4" fill="currentColor"/></svg>
                Add to Chrome
              </a>
      ...
      <div class="bg-zinc-50 border border-zinc-200 rounded-lg p-5">
        <h4 class="font-medium mb-3">Or install from source</h4>
  ...
  <!-- 2. Bookmarklet -->
  <section id="bookmarklet" class="py-16 px-6">
    <div class="max-w-3xl mx-auto">
      <div class="flex items-center gap-3 mb-2">
  ...
  <!-- 3. Embed -->
  <section id="embed" class="py-16 px-6 bg-white border-y border-zinc-200">
    <div class="max-w-3xl mx-auto">
      <div class="flex items-center gap-3 mb-2">
